...
namespace MobileNumberFormatter.Services
{
    ...
    public class MNO_Numbers
    {
        ...
        public MNO GetNumberMobileNetworkProvider(string phoneNumber)
        {
            ...
            {
                throw new Exception("Unable to break phone number into phone number section. Counter check mobile number and try again");
            }
        }
        /// <summary>
        ...
        public MNO GetMobileNetworkProvider(string operatorCode)
        {
            ...
            {
                throw new Exception("Mobile operator code not found.");
            }
        }
    }
}
